...
namespace AnywhereNET
{
    ...
    public class Anywhere
    {
        ...
        public Node SerializeGeneric<TReturn>(Expression<Func<ExecutionContext, TReturn>> expression)
        {
        ...
        public Node SerializeOtherGeneric(Expression expression)
        {
            ...
            switch (expression)
            {
                ...
                case ConstantExpression exp:
                    ...
                    {
                        // TODO: what to do if the type is auto-generated by the compiler?
                        // TODO: serialize this to json instead?
                ...
                case LambdaExpression exp:
                    ...
                    {
                        Body = SerializeOtherGeneric(exp.Body),
                        Name = exp.Name,
                ...
                case MemberExpression exp:
                    ...
                    {
                        Expression = SerializeOtherGeneric(exp.Expression),
                ...
                case MethodCallExpression exp:
                    ...
                    {
                        Object = exp.Object != null ? SerializeOtherGeneric(exp.Object) : null,
                        Arguments = exp.Arguments.Select(a => SerializeOtherGeneric(a)).ToArray(),
                ...
                case UnaryExpression exp:
                    ...
                    {
                        Operand = SerializeOtherGeneric(exp.Operand),
