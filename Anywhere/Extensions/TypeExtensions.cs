...
namespace DidoNet
{
    public static class TypeExtensions
    {
        ...
        /// <summary>
        /// Returns true if the member is serializable by the model-building rules of Anywhere.
        /// </summary>
        ...
        /// <summary>
        /// Throws an exception if the type is not serializable by the model-building rules of Anywhere.
        /// </summary>
        /// <param name="type"></param>
        ...
        /// <summary>
        /// Returns true if the type is serializable by the model-building rules of Anywhere.
        /// </summary>
        /// <param name="type"></param>
        /// <param name="errors"></param>
        /// <returns></returns>
