...
namespace foo
{
    ...
    public class SslTcpClient
    {
        ...
        public static async Task RunClient2(string machineName, string serverName)
        {
            ...
            var connection = new Connection(client, serverName);
        ...
        public static int Main(string[] args)
        {
            ...
            SslTcpClient.RunClient2(machineName, serverCertificateName).GetAwaiter().GetResult();
